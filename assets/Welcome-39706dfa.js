import{n as t,j as n,u as d,s,a as c,b as l,r as x,c as m,d as h}from"./index-7815968b.js";import{b as g}from"./bg_element_des@1x-9d212178.js";import{b}from"./bg_element_des@2x-e16ca0f8.js";const u=t.h3`
  font-weight: 500;
  font-size: 18px;
  margin-bottom: 12px;
`,k=t.li`
...
`,C=()=>{const e=d(),a=()=>{e("/signup")},i=[{text:"Habit drive",id:`${s}#icon-calendar-days`},{text:"View statistics",id:`${s}#icon-presentation-chart-bar`},{text:"Personal rate setting",id:`${s}#icon-wrench-screwdriver`}];return n.jsxs(v,{children:[n.jsx(j,{children:"Water consumption tracker"}),n.jsx(T,{children:"Record daily water intake and track"}),n.jsx(W,{children:"Tracker Benefits"}),n.jsx(z,{children:i.map(({id:r,text:o},p)=>n.jsxs(_,{children:[n.jsx(B,{children:n.jsx("use",{href:r})}),o]},p))}),n.jsx(S,{type:"button",onClick:a,children:"Try tracker"})]})},D=t.div`
display: flex;
margin: auto;
flex-direction: column;
width: 280px;
...
`,M=()=>n.jsxs(D,{children:[n.jsx(C,{}),n.jsx(y,{})]}),P="/TrackerWater/assets/bg_img_mob@1x-c5c3006f.png",E="/TrackerWater/assets/bg_img_mob@2x-cab432e7.png",I="/TrackerWater/assets/bg_img_tab@1x-ae218387.png",L="/TrackerWater/assets/bg_img_tab@2x-6c4f8ac4.png",R="/TrackerWater/assets/bg_img_des@1x-b6cc26cc.png",A="/TrackerWater/assets/bg_img_des@2x-168beeb7.png",H=t.div`
...
`;function q(){const e=c(),i=l()[0].get("token"),r=d();return x.useEffect(()=>{if(i)try{e(m(i)),e(h()).then(o=>{o.error||r("/home")})}catch(o){console.log(o.message)}},[e,r,i]),n.jsx(H,{children:n.jsx(N,{children:n.jsx(M,{})})})}export{q as default};
